...
export default function P17({ navigation, route }) {
  //static defaultProps = {
  //  title: '펀딩 만들기',
  //  buttonColor: 'yellow',
  // }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.threeView}>
        ...
        <View style={{ flexDirection: 'row', height: 40, width: 300, marginLeft: "-3%" }}>
          <TouchableOpacity style={{ marginLeft: "5%" }} onPress={() => { navigation.navigate('AddEvent') }}>
            <Ionicons name="add-circle" size={20} color="grey" />
          </TouchableOpacity>
          <Text style={{ textAlign: 'center', fontSize: 14, color: 'black', fontWeight: 'bold', marginBottom: "2.5%", marginLeft: "1%" }}>이벤트/공지사항 추가</Text>
        </View>
        <View>
          <Text style={{ fontSize: 15, marginBottom: 15, marginLeft: 3 }}>☆리뷰 작성 시 1.5L 음료수 무료 제공해드립니다! 감사합니다!☆</Text>
        </View>
